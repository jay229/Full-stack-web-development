            ...
            <div className="container my-3" >
                ...
                <div className="row">
                    <div className="col-md-4">
                        <NewsItem title="News title" description="News description" imageUrl="https://ichef.bbci.co.uk/news/1024/branded_news/180CC/production/_120680589_gettyimages-1192193014.jpg" />
